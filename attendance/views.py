...
Главное представление — mark_attendance — приведено в дипломе (раздел 3.1)
почти в исходном виде. Доработки по сравнению с фрагментом диплома:
...
def mark_attendance(request):
    """Электронная форма ежедневной отметки посещаемости (диплом, 3.1)."""
    user = request.user
