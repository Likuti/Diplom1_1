...
Основное представление — mark_attendance, электронная форма для выставления
отметок присутствия на выбранную дату. Главные особенности реализации:
1. Валидация selected_date_str — защита от некорректного ввода.
2. Воспитатель видит только свою группу — ограничение по роли.
3. Сохранение посещаемости выполняется в единой транзакции.
"""
...
def mark_attendance(request):
    """Электронная форма ежедневной отметки посещаемости воспитанников."""
    user = request.user
