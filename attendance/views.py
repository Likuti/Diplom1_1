...
Главное представление — mark_attendance — приведено в курсовой (раздел 3.1)
почти в исходном виде. Доработки по сравнению с фрагментом курсовой:
...
def mark_attendance(request):
    """Электронная форма ежедневной отметки посещаемости (курсовая, 3.1)."""
    user = request.user
