...
Отображается в таблицу groups_group. Атрибуты: название, возрастная
категория, направленность (общеразвивающая / компенсирующая / комбинированная),
вместимость (лимит для проверки наполняемости).
"""
